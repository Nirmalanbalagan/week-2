...
public class CreateContact {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.id("firstNameField")).sendKeys("Nirmal");
		driver.findElement(By.id("lastNameField")).sendKeys("Anbalagan");
		driver.findElement(By.id("createContactForm_firstNameLocal")).sendKeys("Nirmal");
		driver.findElement(By.id("createContactForm_lastNameLocal")).sendKeys("Anbalagan");
		...
		driver.findElement(By.id("createContactForm_primaryEmail")).sendKeys("nirmalwolf@gmail.com");
